...
?>
<div class="noo-tl-image"><img src="<?php echo 'modules/' . $module->module . '/assets/images/100_6582.JPG'?>" /></div>
<div id="noo_tl<?php echo $module->id ?>" class="noo-tl<?php echo $params->get('moduleclass_sfx');?>">
	<div class="noo-tl-wrap clearfix">
		<?php $i = 0;?>
		<?php foreach ($lists as $list){?>
			<div class="noo-tl-item <?php if ((!$display && $i==0 ) || ($display == 1)){?> selected<?php }?><?php if ($i++ % 2 == 0 ){?> right<?php }else{?> right<?php }?>">
